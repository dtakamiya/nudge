...
INSERT INTO "new_ActionItem" ("completedAt", "createdAt", "description", "dueDate", "id", "meetingId", "memberId", "sortOrder", "status", "title", "updatedAt") SELECT "completedAt", "createdAt", "description", "dueDate", "id", "meetingId", "memberId", "sortOrder", "status", "title", "updatedAt" FROM "ActionItem";
